...
export default function Footer() {
    return (
        <motion.footer
            ...
            className="bg-gradient-to-b from-[#393C3F] to-[#1A1E21] text-white 2xl:pb-3 lg:pb-2 sm:pb-1 pb-3 2xl:pt-26 xl:pt-16 pt-14">
            <motion.div
                initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ duration: 1, delay: 0.2 }}
                viewport={{ once: true }}
                className="2xl:max-w-[1468px] xl:px-30 lg:px-17 sm:px-10 px-2 ts:px-4 2xl:px-0 mx-auto">
