...
export default function Form() {
    return (
        <motion.section
            ...
            viewport={{ once: true }}
            className="bg-[#C2B173] 2xl:pb-16 xl:pb-11 lg:pb-9 pb-8 2xl:pt-18 xl:pt-13 lg:pt-11 pt-8">
            <div className="2xl:max-w-[1334px] xl:px-30 lg:px-17 sm:px-10 px-2 ts:px-4 2xl:px-0 mx-auto flex flex-col sm:flex-row sm:justify-between justify-center items-center gap-6 sm:gap-0">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="2xl:max-w-[465px] xl:max-w-[310px] lg:max-w-[280px] max-w-[220px] w-full relative">
