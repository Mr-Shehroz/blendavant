...
export default function Hero() {
    return (
        <section className="flex flex-col sm:flex-row justify-center items-center">
            <div className="absolute 2xl:-bottom-39 xl:-bottom-27 lg:-bottom-23 sm:-bottom-14 bottom-20  2xl:-left-10 xl:-left-6 lg:-left-5 sm:-left-4 w-full flex justify-center items-end z-50">
                <Image className="2xl:w-[468px] xl:w-[320px] lg:w-[280px] w-[170px]" src="/hero-scroll.svg" width={100} height={100} alt="scroll" />
            </div>
            <div className="bg-gradient-to-b from-[#393C3F] to-[#1A1E21] sm:h-screen pb-15 sm:w-[89%] w-full text-white">
                <div className="2xl:mt-45 lg:mt-28 mt-20 2xl:max-w-[630px] lg:px-17 md:px-10 sm:px-13 px-2 2xl:px-0 mx-auto sm:text-start text-center">
                    ...
                    <div className="border border-[#A1A1A1] md:w-[70%] w-[80%] mx-auto sm:mx-0 2xl:mt-11 lg:mt-6 mt-4" />
                </div>

                <div className="flex sm:justify-between justify-center gap-10 px-2   items-center sm:text-start text-center 2xl:mt-13 lg:mt-9 mt-6 2xl:max-w-[630px] lg:px-17 md:px-10 sm:px-13 2xl:px-0 mx-auto">
                ...
                <div className="max-w-[630px] mx-auto text-center sm:text-start 2xl:mt-12 lg:mt-8 mt-5 lg:px-17 md:px-10 sm:px-13 2xl:px-0">
                    <button
            ...
            <div className="relative w-full">
                ...
                <Image
                    className="w-full sm:h-[100vh] h-[350px] object-cover"
                    src="/hero.svg"
                    width={500}
                    height={500}
                    alt="hero"
