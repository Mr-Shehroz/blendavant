...
export default function Shipping() {
    return (
        <section className="bg-[#F8F8F8] text-black lg:pb-20 pb-10">
            <div className="2xl:max-w-[1430px] 2xl:px-0 xl:px-30 lg:px-17 px-10 mx-auto">
                <div className="flex items-center justify-between 2xl:pt-55 lg:pt-35 pt-25">
                    <div className="flex 2xl:gap-9 xl:gap-6 lg:gap-4 gap-3 items-center 2xl:max-w-[1120px] xl:max-w-[800px] max-w-[500px]">
                        <div className="border border-[#C5B479] bg-[#C5B479] 2xl:w-[8px] xl:w-[6px] w-[4px] 2xl:h-[139px] xl:h-[100px] lg:h-[90px] h-[70px]"/>
                        <h2 className={`${comfortaa.className} font-bold 2xl:text-[64px] xl:text-[40px] lg:text-[30px] text-[25px] 2xl:leading-[81px] xl:leading-[60px] lg:leading-[40px]`}>Free Shipping On All Orders - Ending Soon</h2>
                    </div>
                    <div>
                        <button className={`${montserrat.className} font-medium 2xl:text-[20px] xl:text-[14px] lg:text-[12px] text-[10px] leading-[100%] bg-black text-white 2xl:w-[181px] xl:w-[120px] lg:w-[100px] w-[75px] 2xl:px-2 px-1 2xl:py-6 xl:py-4 lg:py-3 py-2 transition duration-300 hover:bg-[#333] hover:scale-105`}>SEE MORE</button>
                    </div>
                </div>

                <div className="flex lg:gap-10 gap-5 items-end justify-between 2xl:mt-26 mt-12">
                    ...
                    <div className="border border-[#B7B7B7] 2xl:h-[237px] lg:h-[155px] h-[120px]"/>
                    <div className="2xl:max-w-[370px] max-w-[300px]">
