...
export default function Seller() {
    return (
        <section className="bg-[#F8F8F8] text-black 2xl:py-35 pt-16 xl:pb-24 lg:pb-18 pb-12">
            ...
            <div className="2xl:max-w-[1436px] xl:px-30 lg:px-17 sm:px-10 px-2 2xl:px-0 mx-auto 2xl:mt-12 mt-8 flex flex-col sm:flex-row sm:justify-between justify-center sm:items-end items-center gap-4">
            ...
            <div className="2xl:max-w-[1440px] xl:px-30 lg:px-17 sm:px-10 px-2 2xl:px-0 mx-auto flex flex-col sm:flex-row items-center sm:items-start md:items-center justify-center 2xl:gap-20 md:gap-14 gap-4 2xl:mt-10 mt-7">

                <div className="box-border border-white bg-white border rounded-[10px] flex flex-col pb-4 relative">
                    <Image src="/seller-1.svg" width={400} height={400} alt="seller-1" className="sm:w-full w-[80%] mx-auto sm:mx-0 2xl:h-[402px] xl:h-[280px] lg:h-[250px] sm:h-[200px]" />
                    <button className="absolute 2xl:bottom-31 xl:bottom-19 lg:bottom-16 md:bottom-13 sm:bottom-16 bottom-14 sm:right-5 right-12 bg-black hover:bg-[#333] 2xl:h-[70px] 2xl:w-[70px] xl:h-[55px] xl:w-[55px] lg:h-[45px] lg:w-[45px] h-[35px] w-[35px] rounded-full flex justify-center items-center transition duration-300 hover:scale-105">
                    ...
                    <div className="lg:ml-7 md:ml-3 ml-7 sm:ml-0 mt-4 max-w-[291px]">
                        <h4 className={`${montserrat.className} font-semibold 2xl:text-[36px] xl:text-[26px] lg:text-[22px] text-[18px] leading-[100%] text-black 2xl:mt-11 xl:mt-7 lg:mt-5 md:mt-3`}>$ 184.<span className={`${montserrat.className} font-semibold 2xl:text-[24px] xl:text-[18px] lg:text-[14px] text-[12px] leading-[100%] text-black`}>00</span></h4>
                ...
                <div className="box-border border-white bg-white border rounded-[10px] flex flex-col pb-4 relative">
                    <Image src="/seller-2.svg" width={400} height={400} alt="seller-2" className="sm:w-full w-[80%] mx-auto sm:mx-0 2xl:h-[402px] xl:h-[280px] lg:h-[250px] sm:h-[200px]" />
                    <button className="absolute 2xl:bottom-31 xl:bottom-19 lg:bottom-16 md:bottom-13 sm:bottom-16 bottom-14 sm:right-5 right-12 bg-black hover:bg-[#333] 2xl:h-[70px] 2xl:w-[70px] xl:h-[55px] xl:w-[55px] lg:h-[45px] lg:w-[45px] h-[35px] w-[35px] rounded-full flex justify-center items-center transition duration-300 hover:scale-105">
                ...
                <div className="box-border border-white bg-white border rounded-[10px] flex flex-col pb-4 relative">
                    <Image src="/seller-3.svg" width={400} height={400} alt="seller-3" className="sm:w-full w-[80%] mx-auto sm:mx-0 2xl:h-[402px] xl:h-[280px] lg:h-[250px] sm:h-[200px]" />
                    <button className="absolute 2xl:bottom-31 xl:bottom-19   lg:bottom-16 md:bottom-13 sm:bottom-16 bottom-14 sm:right-5 right-12 bg-black hover:bg-[#333] 2xl:h-[70px] 2xl:w-[70px] xl:h-[55px] xl:w-[55px] lg:h-[45px] lg:w-[45px] h-[35px] w-[35px] rounded-full flex justify-center items-center transition duration-300 hover:scale-105">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="white" className="2xl:size-8 lg:size-5 size-4">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                        </svg>
