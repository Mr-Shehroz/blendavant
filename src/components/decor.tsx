...
export default function Decor() {
    return (
        <motion.section
            ...
            viewport={{ once: true }}
            className="bg-white lg:pb-20 pb-10 text-black 2xl:pt-54 lg:pt-34 pt-20">
            <motion.div
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                className="2xl:max-w-[1430px] xl:px-30 lg:px-17 sm:px-10 px-2 ts:px-4 2xl:px-0 mx-auto mt-11 flex flex-col sm:flex-row sm:justify-between justify-center sm:items-end items-center gap-8 sm:gap-0">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="w-full mx-auto 2xl:max-w-[471px] ex:max-w-[350px] ex:mr-24 exx:mr-38 2xl:mr-0 lg:max-w-[340px] md:max-w-[300px] max-w-[250px] 2xl:mt-23 ex:mb-18 xl:mb-17 lg:mb-10 mt-6">
            ...
            <motion.div
                ...
                viewport={{ once: true }}
                className="2xl:max-w-[1430px] lg:px-30 sm:px-10 px-2 ts:px-4 2xl:px-0 mx-auto lg:mt-20 mt-14">
